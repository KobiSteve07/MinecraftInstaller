...
if exist "C:\Users\"%username%"\KobiWare\prismlauncher" (
    ...
    start "" "C:\Users\"%username%"\KobiWare\UltimMC\UltimMC.exe"
                    ...
                    if(self.paid == "UltimMC"):
                        self.replace_line("C:/Users/" + os.getlogin() + "/KobiWare/UltimMC/accounts.json", 19, "                    \"clientToken\": \""+secrets.token_hex(16)+"\",")
                        self.replace_line("C:/Users/" + os.getlogin() + "/KobiWare/UltimMC/accounts.json", 20, "                    \"userName\": \""+self.gamertag+"\"")
                    self.progress.setValue(100)
